...
8. **Challenge**: Notice how you had to rebuild the requiements on a code change, even though the requirements may not have changed? Let's optimize this:
...
3. Try running tests! 
    ...
    ```bash
    hello_world_tests_1  | ============================= test session starts ==============================
    hello_world_tests_1  | platform linux -- Python 3.6.8, pytest-5.4.3, py-1.9.0, pluggy-0.13.1
    hello_world_tests_1  | rootdir: /app
    hello_world_tests_1  | collected 2 items
    hello_world_tests_1  | 
    hello_world_tests_1  | hello_world_tests/test_client.py ..                                      [100%]
    hello_world_tests_1  | 
    hello_world_tests_1  | ============================== 2 passed in 0.14s ===============================
    simple-falcon-api_hello_world_tests_1 exited with code 0
    Aborting on container exit...
    ```
4. **Challenge**: Change the port using the docker-compose file. Hint: You can set your `API_PORT` environment variable to the port you want before running the `make` or `docker-compose` commands.
...
5. Let's try POST'ing some data... #TODO finish
----
